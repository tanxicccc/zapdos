...
#ifndef CIRCUITNEUMANNPOTENTIAL_H
#define CIRCUITNEUMANNPOTENTIAL_H

#include "IntegratedBC.h"
#include "ProvideMobility.h"

//Forward Declarations
class CircuitNeumannPotential;
class Function;
 ...
 */
class CircuitNeumannPotential : public IntegratedBC
{
public:
	CircuitNeumannPotential(const InputParameters & parameters);
...
#endif // CIRCUITNEUMANNPOTENTIAL_H
